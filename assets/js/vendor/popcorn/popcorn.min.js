...
(function(q,p){function r(a){G.put.call(this,a)}function y(a){this.parent=a;this.byStart=[{start:-1,end:-1}];this.byEnd=[{start:-1,end:-1}];this.animating=[];this.endIndex=this.startIndex=0;this.previousUpdateTime=-1;Object.defineProperty(this,"count",{get:function(){return this.byStart.length}})}function H(a,b){return function(){if(c.plugin.debug)return a.apply(this,arguments);try{return a.apply(this,arguments)}catch(e){c.plugin.errors.push({plugin:b,thrown:e,source:a.toString()});this.emit("pluginerror",
c.plugin.errors)}}}if(p.addEventListener){var w=Array.prototype,A=Object.prototype,B=w.forEach,C=w.slice,v=A.hasOwnProperty,D=A.toString,I=q.Popcorn,z=[],E=false,x={events:{hash:{},apis:{}}},F=function(){return q.requestAnimationFrame||q.webkitRequestAnimationFrame||q.mozRequestAnimationFrame||q.oRequestAnimationFrame||q.msRequestAnimationFrame||function(a){q.setTimeout(a,16)}}(),G={put:function(a){Object.getOwnPropertyNames(a).forEach(function(b){this[b]=a[b]},this)}},c=function(a,b){return new c.p.init(a,
b||null)};c.version="c17e937";c.isSupported=true;c.instances=[];c.p=c.prototype={init:function(a,b){var e,d=this;if(typeof a==="function")if(p.readyState==="complete")a(p,c);else{z.push(a);if(!E){E=true;var g=function(){p.removeEventListener("DOMContentLoaded",g,false);for(var l=0,m=z.length;l<m;l++)z[l].call(p,c);z=null};p.addEventListener("DOMContentLoaded",g,false)}}else{if(typeof a==="string")try{e=p.querySelector(a)}catch(h){throw Error("Popcorn.js Error: Invalid media element selector: "+a);
...
0)d.media.currentTime=0;d.media.removeEventListener("loadedmetadata",j,false);var l,m,o,k,f;l=d.media.duration;l=l!=l?Number.MAX_VALUE:l+1;c.addTrackEvent(d,{start:l,end:l});if(d.options.frameAnimation){d.data.timeUpdate=function(){c.timeUpdate(d,{});c.forEach(c.manifest,function(i,u){if(m=d.data.running[u]){k=m.length;for(var s=0;s<k;s++){o=m[s];(f=o._natives)&&f.frame&&f.frame.call(d,{},o,d.currentTime())}}});d.emit("timeupdate");!d.isDestroyed&&F(d.data.timeUpdate)};!d.isDestroyed&&F(d.data.timeUpdate)}else{d.data.timeUpdate=
function(i){c.timeUpdate(d,i)};d.isDestroyed||d.media.addEventListener("timeupdate",d.data.timeUpdate,false)}};Object.defineProperty(this,"error",{get:function(){return d.media.error}});d.media.readyState>=1?j():d.media.addEventListener("loadedmetadata",j,false);return this}}};c.p.init.prototype=c.p;c.byId=function(a){for(var b=c.instances,e=b.length,d=0;d<e;d++)if(b[d].id===a)return b[d];return null};c.forEach=function(a,b,e){if(!a||!b)return{};e=e||this;var d,g;if(B&&a.forEach===B)return a.forEach(b,
e);if(D.call(a)==="[object NodeList]"){d=0;for(g=a.length;d<g;d++)b.call(e,a[d],d,a);return a}for(d in a)v.call(a,d)&&b.call(e,a[d],d,a);return a};c.extend=function(a){var b=C.call(arguments,1);c.forEach(b,function(e){for(var d in e)a[d]=e[d]});return a};c.extend(c,{noConflict:function(a){if(a)q.Popcorn=I;return c},error:function(a){throw Error(a);},guid:function(a){c.guid.counter++;return(a?a:"")+(+new Date+c.guid.counter)},sizeOf:function(a){var b=0,e;for(e in a)b++;return b},isArray:Array.isArray||
function(a){return D.call(a)==="[object Array]"},nop:function(){},position:function(a){if(!a.parentNode)return null;a=a.getBoundingClientRect();var b={},e=p.documentElement,d=p.body,g,h,j;g=e.clientTop||d.clientTop||0;h=e.clientLeft||d.clientLeft||0;j=q.pageYOffset&&e.scrollTop||d.scrollTop;e=q.pageXOffset&&e.scrollLeft||d.scrollLeft;g=Math.ceil(a.top+j-g);h=Math.ceil(a.left+e-h);for(var l in a)b[l]=Math.round(a[l]);return c.extend({},b,{top:g,left:h})},disable:function(a,b){if(!a.data.disabled[b]){a.data.disabled[b]=
...
c.Events.Natives=c.Events.UIEvents+" "+c.Events.MouseEvents+" "+c.Events.Events;x.events.apiTypes=["UIEvents","MouseEvents","Events"];(function(a,b){for(var e=x.events.apiTypes,d=a.Natives.split(/\s+/g),g=0,h=d.length;g<h;g++)b.hash[d[g]]=true;e.forEach(function(j){b.apis[j]={};for(var l=a[j].split(/\s+/g),m=l.length,o=0;o<m;o++)b.apis[j][l[o]]=true})})(c.Events,x.events);c.events={isNative:function(a){return!!x.events.hash[a]},getInterface:function(a){if(!c.events.isNative(a))return false;var b=
x.events,e=b.apiTypes;b=b.apis;for(var d=0,g=e.length,h,j;d<g;d++){j=e[d];if(b[j][a]){h=j;break}}return h},all:c.Events.Natives.split(/\s+/g),fn:{trigger:function(a,b){var e,d=this.data.events[a];if(d){if(e=c.events.getInterface(a)){e=p.createEvent(e);e.initEvent(a,true,true,q,1);this.media.dispatchEvent(e);return this}for(e=d.slice();e.length;)e.shift().call(this,b)}return this},listen:function(a,b){var e=this,d=true,g=c.events.hooks[a],h,j;if(typeof b!=="function")throw Error("Popcorn.js Error: Listener is not a function");
...
true}}}}};c.forEach([["trigger","emit"],["listen","on"],["unlisten","off"]],function(a){c.p[a[0]]=c.p[a[1]]=c.events.fn[a[0]]});r.start=function(a,b){if(b.end>a.media.currentTime&&b.start<=a.media.currentTime&&!b._running){b._running=true;a.data.running[b._natives.type].push(b);if(!a.data.disabled[b._natives.type]){b._natives.start.call(a,null,b);a.emit("trackstart",c.extend({},b,{plugin:b._natives.type,type:"trackstart",track:b}))}}};r.end=function(a,b){var e;if((b.end<=a.media.currentTime||b.start>
...
a.end<this.parent.data.trackEvents.previousUpdateTime&&this.parent.data.trackEvents.endIndex++};y.prototype.remove=function(a){if(a instanceof r)a=a.id;if(typeof a==="object"){this.where(a).forEach(function(k){this.removeTrackEvent(k._id)},this.parent);return this}var b,e,d;d=this.byStart.length;for(var g=0,h=0,j=[],l=[],m=[],o=[];--d>-1;){b=this.byStart[g];e=this.byEnd[g];if(!b._id){j.push(b);l.push(e)}if(b._id){b._id!==a&&j.push(b);e._id!==a&&l.push(e);if(b._id===a)h=g}g++}d=this.animating.length;
g=0;if(d)for(;--d>-1;){b=this.animating[g];b._id||m.push(b);b._id&&b._id!==a&&m.push(b);g++}h<=this.startIndex&&this.startIndex--;h<=this.endIndex&&this.endIndex--;this.byStart=j;this.byEnd=l;this.animating=m;d=this.parent.data.history.length;for(g=0;g<d;g++)this.parent.data.history[g]!==a&&o.push(this.parent.data.history[g]);this.parent.data.history=o};c.addTrackEvent=function(a,b){if(!(b instanceof r)){if((b=new r(b))&&b._natives&&b._natives.type&&a.options.defaults&&a.options.defaults[b._natives.type])b=
c.extend({},a.options.defaults[b._natives.type],b);if(b._natives){b._id=b.id||b._id||c.guid(b._natives.type);if(b._natives._setup){b._natives._setup.call(a,b);a.emit("tracksetup",c.extend({},b,{plugin:b._natives.type,type:"tracksetup",track:b}))}}a.data.trackEvents.add(b);r.start(a,b);this.timeUpdate(a,null,true);b._id&&c.addTrackEvent.ref(a,b);a.emit("trackadded",c.extend({},b,b._natives?{plugin:b._natives.type}:{},{type:"trackadded",track:b}))}};c.addTrackEvent.ref=function(a,b){a.data.trackRefs[b._id]=
...
0)c.error("'"+a+"' is a protected function name");else{var d=typeof b==="function",g=["start","end","type","manifest"],h=["_setup","_teardown","start","end","frame"],j={},l=function(k,f){k=k||c.nop;f=f||c.nop;return function(){k.apply(this,arguments);f.apply(this,arguments)}};c.manifest[a]=e=e||b.manifest||{};h.forEach(function(k){b[k]=H(b[k]||c.nop,a)});var m=function(k,f){if(!f)return this;if(f.ranges&&c.isArray(f.ranges)){c.forEach(f.ranges,function(n){n=c.extend({},f,n);delete n.ranges;this[a](n)},
this);return this}var i=f._natives={},u="",s;c.extend(i,k);f._natives.type=f._natives.plugin=a;f._running=false;i.start=i.start||i["in"];i.end=i.end||i.out;if(f.once)i.end=l(i.end,function(){this.removeTrackEvent(f._id)});i._teardown=l(function(){var n=C.call(arguments),t=this.data.running[i.type];n.unshift(null);n[1]._running&&t.splice(t.indexOf(f),1)&&i.end.apply(this,n);n[1]._running=false;this.emit("trackend",c.extend({},f,{plugin:i.type,type:"trackend",track:c.getTrackEvent(this,f.id||f._id)}))},
i._teardown);i._teardown=l(i._teardown,function(){this.emit("trackteardown",c.extend({},f,{plugin:a,type:"trackteardown",track:c.getTrackEvent(this,f.id||f._id)}))});f.compose=f.compose||[];if(typeof f.compose==="string")f.compose=f.compose.split(" ");f.effect=f.effect||[];if(typeof f.effect==="string")f.effect=f.effect.split(" ");f.compose=f.compose.concat(f.effect);f.compose.forEach(function(n){u=c.compositions[n]||{};h.forEach(function(t){i[t]=l(i[t],u[t])})});f._natives.manifest=e;if(!("start"in
f))f.start=f["in"]||0;if(!f.end&&f.end!==0)f.end=f.out||Number.MAX_VALUE;if(!v.call(f,"toString"))f.toString=function(){var n=["start: "+f.start,"end: "+f.end,"id: "+(f.id||f._id)];f.target!=null&&n.push("target: "+f.target);return a+" ( "+n.join(", ")+" )"};if(!f.target){s="options"in e&&e.options;f.target=s&&"target"in s&&s.target}if(!f._id&&f._natives)f._id=c.guid(f._natives.type);if(f instanceof r){if(f._natives){f._id=f.id||f._id||c.guid(f._natives.type);if(f._natives._setup){f._natives._setup.call(this,
f);this.emit("tracksetup",c.extend({},f,{plugin:f._natives.type,type:"tracksetup",track:f}))}}this.data.trackEvents.add(f);r.start(this,f);this.timeUpdate(this,null,true);f._id&&c.addTrackEvent.ref(this,f)}else c.addTrackEvent(this,f);c.forEach(k,function(n,t){g.indexOf(t)===-1&&this.on(t,n)},this);return this};c.p[a]=j[a]=function(k,f){var i,u;if(k&&!f)f=k;else if(i=this.getTrackEvent(k)){u=f;var s={},n;for(n in i)if(v.call(u,n)&&v.call(i,n))s[n]=i[n];if(i._natives._update){this.data.trackEvents.remove(i);
if(v.call(f,"start"))i.start=f.start;if(v.call(f,"end"))i.end=f.end;r.end(this,i);d&&b.call(this,i);i._natives._update.call(this,i,f);this.data.trackEvents.add(i);r.start(this,i)}else{c.extend(i,f);this.data.trackEvents.remove(k);i._natives._teardown&&i._natives._teardown.call(this,i);c.removeTrackEvent.ref(this,k);if(d)m.call(this,b.call(this,i),i);else{i._id=i.id||i._id||c.guid(i._natives.type);if(i._natives&&i._natives._setup){i._natives._setup.call(this,i);this.emit("tracksetup",c.extend({},i,
{plugin:i._natives.type,type:"tracksetup",track:i}))}this.data.trackEvents.add(i);r.start(this,i);this.timeUpdate(this,null,true);c.addTrackEvent.ref(this,i)}this.emit("trackchange",{id:i.id,type:"trackchange",previousValue:s,currentValue:i,track:i});return this}i._natives.type!=="cue"&&this.emit("trackchange",{id:i.id,type:"trackchange",previousValue:s,currentValue:u,track:i});return this}else f.id=k;this.data.running[a]=this.data.running[a]||[];i=c.extend({},this.options.defaults&&this.options.defaults[a]||
{},f);m.call(this,d?b.call(this,i):b,i);return this};e&&c.extend(b,{manifest:e});var o={fn:j[a],definition:b,base:b,parents:[],name:a};c.registry.push(c.extend(j,o,{type:a}));c.registryByName[a]=o;return j}};c.plugin.errors=[];c.plugin.debug=c.version==="c17e937";c.removePlugin=function(a,b){if(!b){b=a;a=c.p;if(c.protect.natives.indexOf(b.toLowerCase())>=0){c.error("'"+b+"' is a protected function name");return}var e=c.registry.length,d;for(d=0;d<e;d++)if(c.registry[d].name===b){c.registry.splice(d,
...
j;h++)if(g[h]&&g[h]._natives&&g[h]._natives.type===b){g.splice(h,1);h--;j--}};c.compositions={};c.compose=function(a,b,e){c.manifest[a]=e||b.manifest||{};c.compositions[a]=b};c.plugin.effect=c.effect=c.compose;var J=/^(?:\.|#|\[)/;c.dom={debug:false,find:function(a,b){var e=null;b=b||p;if(a){if(!J.test(a)){e=p.getElementById(a);if(e!==null)return e}try{e=b.querySelector(a)}catch(d){if(c.dom.debug)throw Error(d);}}return e}};var K=/\?/,L={url:"",data:"",dataType:"",success:c.nop,type:"GET",async:true,
xhr:function(){return new q.XMLHttpRequest}};c.xhr=function(a){a.dataType=a.dataType&&a.dataType.toLowerCase()||null;if(a.dataType&&(a.dataType==="jsonp"||a.dataType==="script"))c.xhr.getJSONP(a.url,a.success,a.dataType==="script");else{a=c.extend({},L,a);a.ajax=a.xhr();if(a.ajax){if(a.type==="GET"&&a.data){a.url+=(K.test(a.url)?"&":"?")+a.data;a.data=null}a.ajax.open(a.type,a.url,a.async);a.ajax.send(a.data||null);return c.xhr.httpData(a)}}};c.xhr.httpData=function(a){var b,e=null,d,g=null;a.ajax.onreadystatechange=
function(){if(a.ajax.readyState===4){try{e=JSON.parse(a.ajax.responseText)}catch(h){}b={xml:a.ajax.responseXML,text:a.ajax.responseText,json:e};if(!b.xml||!b.xml.documentElement){b.xml=null;try{d=new DOMParser;g=d.parseFromString(a.ajax.responseText,"text/xml");if(!g.getElementsByTagName("parsererror").length)b.xml=g}catch(j){}}if(a.dataType)b=b[a.dataType];a.success.call(a.ajax,b)}};return b};c.xhr.getJSONP=function(a,b,e){var d=p.head||p.getElementsByTagName("head")[0]||p.documentElement,g=p.createElement("script"),
h=false,j=[];j=/(=)\?(?=&|$)|\?\?/;var l,m;if(!e){m=a.match(/(callback=[^&]*)/);if(m!==null&&m.length){j=m[1].split("=")[1];if(j==="?")j="jsonp";l=c.guid(j);a=a.replace(/(callback=[^&]*)/,"callback="+l)}else{l=c.guid("jsonp");if(j.test(a))a=a.replace(j,"$1"+l);j=a.split(/\?(.+)?/);a=j[0]+"?";if(j[1])a+=j[1]+"&";a+="callback="+l}window[l]=function(o){b&&b(o);h=true}}g.addEventListener("load",function(){e&&b&&b();h&&delete window[l];d.removeChild(g)},false);g.src=a;d.insertBefore(g,d.firstChild)};c.getJSONP=
c.xhr.getJSONP;c.getScript=c.xhr.getScript=function(a,b){return c.xhr.getJSONP(a,b,true)};c.util={toSeconds:function(a,b){var e=/^([0-9]+:){0,2}[0-9]+([.;][0-9]+)?$/,d,g,h;if(typeof a==="number")return a;typeof a==="string"&&!e.test(a)&&c.error("Invalid time format");e=a.split(":");d=e.length-1;g=e[d];if(g.indexOf(";")>-1){g=g.split(";");h=0;if(b&&typeof b==="number")h=parseFloat(g[1],10)/b;e[d]=parseInt(g[0],10)+h}d=e[0];return{1:parseFloat(d,10),2:parseInt(d,10)*60+parseFloat(e[1],10),3:parseInt(d,
10)*3600+parseInt(e[1],10)*60+parseFloat(e[2],10)}[e.length||1]}};c.p.cue=c.p.exec;c.protect={natives:function(a){return Object.keys?Object.keys(a):function(b){var e,d=[];for(e in b)v.call(b,e)&&d.push(e);return d}(a)}(c.p).map(function(a){return a.toLowerCase()})};c.forEach({listen:"on",unlisten:"off",trigger:"emit",exec:"cue"},function(a,b){var e=c.p[b];c.p[b]=function(){if(typeof console!=="undefined"&&console.warn){console.warn("Deprecated method '"+b+"', "+(a==null?"do not use.":"use '"+a+"' instead."));
c.p[b]=e}return c.p[a].apply(this,[].slice.call(arguments))}});q.Popcorn=c}else{q.Popcorn={isSupported:false};for(w="byId forEach extend effects error guid sizeOf isArray nop position disable enable destroyaddTrackEvent removeTrackEvent getTrackEvents getTrackEvent getLastTrackEventId timeUpdate plugin removePlugin compose effect xhr getJSONP getScript".split(/\s+/);w.length;)q.Popcorn[w.shift()]=function(){}}})(window,window.document);
